	...
	$.fn.niceSelect = function(method) {
		...
		function create_nice_select($select) {
			$select.after($('<div></div>')
				...
				.html($select.attr('multiple') ? '<span class="multiple-options"></span><div class="nice-select-search-box"><input type="text" class="nice-select-search" placeholder="Search..."/></div><ul class="list"></ul>' : '<span class="current"></span><div class="nice-select-search-box"><input type="text" class="nice-select-search" placeholder="Search..."/></div><ul class="list"><li data-value="All Categories" class="option">All Categories</li><li data-value="Shops" class="option">Shops</li><li data-value="Hotels" class="option">Hotels</li><li data-value="Restaurants" class="option">Restaurants</li><li data-value="Fitness" class="option">Fitness</li><li data-value="Events" class="option">Events</li></ul>')
			);
